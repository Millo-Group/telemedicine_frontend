export default function AssessmentAcctionModule() {
  return (
<div>
<button type="button" className="border-0 bg-white text-success" data-bs-toggle="modal" data-bs-target="#exampleModal4">
  ...
  <div className="modal-dialog m-4" style={{maxWidth:'100%'}}>
    <div className="modal-content">
      <div className="modal-header py-2 px-4">
        <h1 className="modal-title fs-5" id="exampleModalLabel4">Input Box</h1>
      </div>
