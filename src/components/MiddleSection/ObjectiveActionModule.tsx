export default function ObjectiveActionModule() {
  return (
<div>
<button type="button" className="border-0 bg-white text-success" data-bs-toggle="modal" data-bs-target="#exampleModal3">
  ...
  <div className="modal-dialog m-4" style={{maxWidth:'100%'}}>
    <div className="modal-content">
      <div className="modal-header py-2 px-4">
        <h1 className="modal-title fs-5" id="exampleModalLabel3">Input Box</h1>
      </div>
